 ...
 */
	...
	struct ssl_tls_record_layer
	{
		...
		unsigned short int recordVersion;
...
#pragma pack(push, 1)
	struct ssl_tls_client_server_hello : ssl_tls_handshake_layer
	{
		...
		unsigned short int handshakeVersion;
...
#pragma pack(push, 1)
	...
	{
		/** Unused byte */
		unsigned int changeCipherSpec:8;
	};
#pragma pack(pop)
...
#pragma pack(push, 1)
	struct ssl_tls_alert
	{
		...
		unsigned int alertLevel:8;
		/** Alert description (one of ::SSLAlertDescription) */
		unsigned int alertDescription:8;
	};
#pragma pack(pop)
